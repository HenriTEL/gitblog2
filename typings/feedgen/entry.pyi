...
class FeedEntry:
    ...
    def id(self, id: str = ...) -> str:
        ...
        """
        ...
    def guid(self, guid=..., permalink=...):  # -> dict[str, Unknown]:
        ...
        """
        ...
    def updated(self, updated: Union[str, datetime] = ...) -> datetime:
    ...
    def link(
        self,
        link: Union[dict[str, str], list[dict[str, str]]] = ...,
        replace: bool = ...,
        **kwargs: str
    ) -> list[dict[str, str]]:
        ...
        """
        ...
    def summary(self, summary: str = ..., type: Any = ...) -> str:
    ...
    def category(self, category=..., replace=..., **kwargs):  # -> list[Unknown] | None:
        ...
        ...
    def contributor(
        self, contributor=..., replace=..., **kwargs
    ):  # -> list[Unknown] | None:
    ...
    def register_extension(
        self, namespace, extension_class_entry=..., atom=..., rss=...
    ):  # -> None:
