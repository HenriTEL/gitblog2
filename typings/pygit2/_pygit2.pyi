...
class Blob(Object):
    ...
    def diff_to_buffer(self, buffer: Optional[bytes] = ..., flag: int = ..., old_as_path: str = ..., buffer_as_path: str = ...) -> Patch:
        ...
...
class Patch:
    ...
    delta: DiffDelta
    hunks: list[DiffHunk]
    line_stats: tuple[int, int, int]
    text: str | None
    @staticmethod
    def create_from(old: Blob | bytes | None, new: Blob | bytes | None, old_as_path: str = ..., new_as_path: str = ..., flag: int = ..., context_lines: int = ..., interhunk_lines: int = ...) -> Patch:
        ...
...
class Repository:
    ...
    def applies(self, diff: Diff, location: int = ..., raise_error: bool = ...) -> bool:
        ...
    ...
    def create_commit_with_signature(self, content: str, signature: str, signature_field: Optional[str] = ...) -> Oid:
        ...
    
    def create_note(self, message: str, author: Signature, committer: Signature, annotated_id: str, ref: str = ..., force: bool = ...) -> Oid:
        ...
    
    def create_reference_direct(self, name: str, target: _OidArg, force: bool, message: Optional[str] = ...) -> Reference:
        ...
    
    def create_reference_symbolic(self, name: str, target: str, force: bool, message: Optional[str] = ...) -> Reference:
        ...
    ...
    def init_submodules(self, submodules: Optional[list[Submodule]] = ..., overwrite=...) -> None:
        ...
    ...
    def status(self, untracked_files: str = ..., ignored: bool = ...) -> dict[str, int]:
        ...
...
class Signature:
    ...
    raw_name: bytes
    time: int
    def __init__(self, name: str, email: str, time: int = ..., offset: int = ..., encoding: Optional[str] = ...) -> None:
        ...
